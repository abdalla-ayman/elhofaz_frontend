  ...
  >
    <Container>
      ...
      <Container>
        ...
        <Typography variant="body6" sx={{fontSize: '14px'}}>هو برنامج يهتم بتعليم القرآن الكريم وعلومه، يعتمد على منهج مجرب، يقوم على آلية معينة للحفظ والمراجعة (بمنهجية مقارئ الحفاظ)
      </Typography>
      </Container>
      <Container>
