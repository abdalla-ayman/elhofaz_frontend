...
export default function lessons() {
  ...
  const lessonTitels = ['سورة الفاتحة','آداب تلاوة القرآن الكريم','مقدمة في علم التجويد','الاستعاذة و البسملة','أحكام النون الساكنة و التجويد','الإظهار الحلقي','الإدغام','الإقلاب','الإخفاء الحقيقي','الميم و النون المشددتين','الميم الساكنة','القلقلة','حكم اللامات السواكن','مقدمة المدود','المد الفرعي بسبب الهمز','المد الفرعي بسبب السكون','المد في الحروف الهجائية السور','تتمة المدود','همزة الوصل و همزة القطع','أحكام تتعلق بهمزة الوصل','هاء التأنيث','المقطوع و الموصول','الوقف و الإبتداء','أقسام الوقف','مخارج الحروف','صفات الحروف','صفات الحروف التي لها ضد','صفات الحروف التي ليس لها ضد','الحروف والصفات حسب القوة والضعف','المثلان','المتقاربان','المتجانسان و المتباعدان','التفخيم و الترقيق','أحكام حرف الراء','الرّوْم و الإشمام','فوائد مهمة يجب مراعاتها']
